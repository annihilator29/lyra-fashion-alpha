-- Migration: Force update products with craftsmanship_content sample data
-- Story 2-5: Craftsmanship Content Integration in PDP
-- Created: 2025-12-12
-- NOTE: This migration OVERWRITES existing craftsmanship_content data to ensure
-- the new structure (materials.fabric/origin/composition) is used

-- Update ALL dresses with craftsmanship data (overwrite any existing)
UPDATE products
...
-- Update ALL tops with craftsmanship data
UPDATE products
SET craftsmanship_content = jsonb_build_object(
    'materials', jsonb_build_object(
...
-- Update ALL bottoms with craftsmanship data
UPDATE products
SET craftsmanship_content = jsonb_build_object(
    'materials', jsonb_build_object(
...
-- Update ALL outerwear with craftsmanship data
UPDATE products
SET craftsmanship_content = jsonb_build_object(
    'materials', jsonb_build_object(
...
-- Update ALL accessories with craftsmanship data
UPDATE products
SET craftsmanship_content = jsonb_build_object(
    'materials', jsonb_build_object(
